#!/usr/bin/env python3
"""
The cases for `scripts/validate-config.py`, moved out of it - the entry-point shape.
...
`_policy` is imported under its own name, the way `validate-config.py` imports it,
