...
curl -fsSL https://raw.githubusercontent.com/AleksandarBisevac/claude-plugins/v3.0.1/plugins/audit/templates/audit-plan.starter.json -o docs/audit/audit-plan.json
curl -fsSL https://raw.githubusercontent.com/AleksandarBisevac/claude-plugins/v3.0.1/plugins/audit/templates/audit.config.example.json -o .claude/audit.config.json   # optional
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/AleksandarBisevac/claude-plugins/v3.0.1/plugins/audit/schema/audit-plan.schema.json -o /tmp/audit-plan.schema.json
