...
repo: acme-store · generated 2026-07-16 10:03 UTC
...
| id | title | status | model | risk | commit | ADO |
|---|---|---|---|---|---|---|
| P1.1 | Hash passwords with Argon2id | done | sonnet | high | 9a1f0c2 | #1421 |
| P1.2 | Rate-limit the login endpoint | done | sonnet | med | b2d7e58 | — |
...
| id | title | status | model | risk | commit | ADO |
|---|---|---|---|---|---|---|
| P2.1 | Validate the checkout payload | done | sonnet | med | c4a11b9 | — |
| P2.2 | Sanitize the product-search query | in_progress | sonnet | high | — | — |
| P2.3 | Escape server-rendered template output | blocked | sonnet | med | — | — |
...
| id | title | status | model | risk | commit | ADO |
|---|---|---|---|---|---|---|
| BF1.1 | Fix BUG-3: cart total off-by-one with stacked discounts | in_progress | sonnet | med | — | — |
| BF1.2 | Fix BUG-4: logout leaves the session cookie | done | sonnet | high | a1b2c3d | — |
